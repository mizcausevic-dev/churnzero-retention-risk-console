...
const PRODUCT = {
  "repo": "churnzero-retention-risk-console",
  "vendor": "ChurnZero",
  "title": "retention risk console",
  "domain": "Customer Success",
  "audience": "CS leaders, account teams, renewals operators, and SaaS value architects",
  "problem": "Retention risk is hard to act on when product usage, sentiment, renewal timing, and executive coverage do not resolve into one decision.",
  "workflow": "The product turns account health, adoption gaps, renewal blockers, and save-plan ownership into a retention command surface.",
  "business": "Leaders can prioritize save motions, expansion candidates, and accounts where the value narrative no longer holds.",
  "technical": "Synthetic retention lanes are scored through a CLI and published as a static customer-risk brief.",
  "integration": "ChurnZero journeys, account health, milestones, playbooks, renewal windows, and executive notes.",
  "keywords": [
    "ChurnZero",
    "retention risk",
    "customer success",
